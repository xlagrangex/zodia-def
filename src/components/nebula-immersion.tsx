  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
        ...
        <div className="sm:hidden flex items-center justify-center space-x-6 mt-6 animate-fade-in-stagger" style={{ animationDelay: "0.8s" }}>
          {/* X/Twitter */}
          <a
            href="https://x.com/Zodia_agent"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#E6F3FF] hover:text-[#00CCFF] transition-colors duration-300 p-2 rounded-md hover:bg-[#00CCFF]/10 flex items-center justify-center"
          >
