      ...
      <div className="sm:hidden">
        ...
        <div className="flex items-center justify-center space-x-4 pt-1 pb-0 -mb-1 w-full max-w-xs mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#E6F3FF] hover:text-[#00CCFF] transition-colors duration-300 p-1.5 rounded-md hover:bg-[#00CCFF]/10 flex items-center justify-center"
          >
        ...
        <div className="flex items-center justify-between px-4 py-0">
          ...
          <a
            href="mailto:hello@zodia.world"
            className="text-[#E6F3FF] hover:text-[#00CCFF] transition-colors duration-300 text-xs flex items-center"
          >
            <span className="font-trajan">hello</span>
            <span className="font-sans">@</span>
            <span className="font-trajan">zodia.world</span>
