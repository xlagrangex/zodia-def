        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center -space-x-1 sm:space-x-3">
            ...
            <a
              ...
              className="text-[#E6F3FF] hover:text-[#00CCFF] transition-colors duration-300 p-0.5 sm:p-1 rounded-md hover:bg-[#00CCFF]/10"
            >
            ...
            {/* DeXtools */}
            <a
              href="https://dexscreener.com/ethereum/0x1234567890123456789012345678901234567890"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#E6F3FF] hover:text-[#00CCFF] transition-colors duration-300 p-0.5 sm:p-1 rounded-md hover:bg-[#00CCFF]/10"
            >
              <img src="/dext.svg" alt="DeXtools" className="w-4 h-4 sm:w-5 sm:h-5" />
            </a>

            {/* Telegram */}
            <a
              href="https://t.me/zodia_def"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#E6F3FF] hover:text-[#00CCFF] transition-colors duration-300 p-0.5 sm:p-1 rounded-md hover:bg-[#00CCFF]/10"
            >
